...
namespace MauiPersianCalendar
{
    public partial class Calendar : ContentView
    {
        ...
        public static readonly BindableProperty SelectedBackgroundColorProperty =
            BindableProperty.Create(nameof(SelectedBackgroundColor), typeof(Color), typeof(Calendar), Colors.Black,
        ...
        {
            if (newValue == oldValue) return;
            buttons.FindAll(b => b.IsSelected).ForEach(b => b.BackgroundColor = (newValue != Colors.Black ? newValue : Colors.Transparent));
        }
        ...
        public static readonly BindableProperty SelectedTextColorProperty =
            BindableProperty.Create(nameof(SelectedTextColor), typeof(Color), typeof(Calendar), Colors.Black,
        ...
        {
            if (newValue == oldValue) return;
            buttons.FindAll(b => b.IsSelected).ForEach(b => b.TextColor = (newValue != Colors.Black ? newValue : Colors.Black));
        }
        ...
        protected void SetButtonSelected(CalendarButton button, SpecialDate special, bool first = false, bool last = false)
        {
            Device.BeginInvokeOnMainThread(() =>
            {
                ...
                button.BackgroundColor = SelectedBackgroundColor != Colors.Black ? SelectedBackgroundColor : (special != null && special.BackgroundColor.IsNotDefault() ? special.BackgroundColor : defaultBackgroundColor);
                button.TextColor = SelectedTextColor != Colors.Black ? SelectedTextColor : (special != null && special.TextColor.IsNotDefault() ? special.TextColor : defaultTextColor);
